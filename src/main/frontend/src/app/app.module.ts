...
import { PostPageModule } from "./modules/post-pages/post-page.module";
...
import { PostCommentConverter } from "./modules/post-comments/converter/post-comment.converter";
import { PostCommentHttpServices } from "./modules/post-comments/services/post-comment.http.service";
...
const routes: Routes = [
  {
    path: "",
    loadChildren: "./modules/post-pages/post-page.module#PostPageModule",
  },
];
